...
async def process_email_endpoint(
    ...
    return {
        ...
        'target_gender': 'Male',
        'target_age': '18-24',
        'cohort_auds': {'Small and Medium Industries': [{'name': 'Interest: Business & Industries > Agriculture', 'description': 'Interest: Business & Industries > Agriculture', 'abvr': 'sf6', 'similarity': 0.7218635824428371}, {'name': 'InM_IndiaMart-Agriculture & Farming', 'description': 'Users who have shown interest in buying Agriculture & Farming related products', 'abvr': 'rau', 'similarity': 0.7212520931986481}, {'name': 'CVOP_HOSACHIGURU ABHIVRUDHI FARMS LLP_74728_thankyou', 'description': 'Achievers of goal with Id: 6268', 'abvr': 'kzq', 'similarity': 0.48741199767924054}, {'name': 'CVOP_HOSACHIGURU ABHIVRUDHI FARMS LLP_10265_Landing Page', 'description': 'Achievers of goal with Id:10265', 'abvr': 'r8r', 'similarity': 0.4679547996157367}]},
        'cohort_ppts': {'Small and Medium Industries': 'https://docs.google.com/presentation/d/18ZeVRf5d9fuagJWweV2quDeE-pM8HaxTM8p5s1BNyj0', 'NCCSAB': 'https://docs.google.com/presentation/d/11zqWvNyFDlIEyUGlXXgWFNBSzgDyntwQaTRVZc41ykc'},
